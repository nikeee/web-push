...
describe("sendNotification", () => {
  ...
  function validateRequest(request) {
    ...
    const isGCM = options.subscription.endpoint.indexOf("https://android.googleapis.com/gcm") === 0;
    const isFCM = options.subscription.endpoint.indexOf("https://fcm.googleapis.com/fcm") === 0;
